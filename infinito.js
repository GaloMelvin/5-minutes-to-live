//poner pantalla completa automaticamente
document.addEventListener('DOMContentLoaded', function() {
  const body = document.body;

  // Intenta poner en pantalla completa al cargar la página
  if (document.fullscreenEnabled) {
      body.requestFullscreen().catch((err) => {
          console.log("Error al activar pantalla completa automáticamente:", err);
      });
  }
});
...
// Modificar el bucle principal del juego para pausar el juego
function gameLoop() {
